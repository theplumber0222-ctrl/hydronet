...
const en = {
  ...
  stripeUi: {
    checkoutDepositSummary:
      "Non-Gold: a $50 deposit is required to schedule (credited to total); balance on service date. Gold: subscription only (no $50 deposit).",
    depositLegal:
      "Single visits & hourly: $50 deposit — refunds per Cancellations & refunds. Gold: subscription (no $50 deposit). Tennessee commercial laws apply.",
    slaNote:
  ...
  pricing: {
    ...
    singleVisitPolicyNote:
      "A $50 reservation is required to schedule a visit. Refund of the $50 requires cancellation with at least 24 hours’ notice. Thank you for giving us the opportunity to serve you.",
    ...
    ctaJoinAnnual: "Join — pay $2,200 / year",
    ctaJoinMonthly: "Join — $183.33 / mo",
    hourlyTitle: "HydroNet Plumbing",
    hourlyKicker: "Hourly · installs & repairs",
    hourlyIntro:
      "A $50 reservation is required to schedule a visit; refundable if you cancel with at least 24 hours’ notice. This service covers one hour of labor at the price shown; the total due depends on the work to be done and parts needed. If the project requires more than four hours, we will provide a quote and the $50 to book will count toward the total charge.",
    hourlyBullet1:
    ...
    reservationAppliesAll:
      "Single visits & hourly: $50 reservation (not Gold). Full policy: Cancellations & refunds.",
  },
  sticky: {
    ctaBook: "Book appointment",
  },
  ...
  bookGold: {
    ...
    intro:
      "Three included visits per year (~every four months); you can book earlier if needed. Extras and weekend emergencies are paid in full at booking. Gold visits do not use the $50 reservation.",
    visitsSummary:
    ...
    memberNoDepositLegal:
      "Gold member visits do not use the $50 reservation.",
    termsLead:
  ...
  booking: {
    ...
    hourlyRate: "Hourly ($150)",
    serviceLabel: "Service type",
    hourlyBox:
      "Specialized technical work under IPC 2018. Minimum charge: 1 hour in Stripe ($150); additional time billed per job on site.",
    ...
    serviceLine: "Service:",
    hourlyRateLine: "Rate:",
    hourlyMin: "/ hour or fraction (minimum 1 hour on this booking).",
    ...
    reserveToday: "Reservation today:",
    balanceDue: "Balance due:",
    depositNoteStandard:
      "A $50 deposit is required to schedule. Cancellation requires at least 24 hours notice. Refund rules: Cancellations & refunds.",
    hourlyLegal:
      "$50 reservation; minimum 1 hour in Stripe. Additional time per HydroNet policy. Refunds: Cancellations & refunds.",
    termsCheckbox:
    ...
    services: {
      drainage: {
        ...
        hint: "High-pressure drain line cleaning; commercial and residential.",
      },
      water_heater: {
        label:
  ...
  checkoutStripe: {
    ...
    emergencyNonMemberSubmit:
      "$50 reservation today; balance on service date.",
  },
  legal: legalEn,
};
