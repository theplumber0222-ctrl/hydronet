...
const en = {
  ...
  adminHistorial: {
    ...
    pageSubtitle:
      "Reservations, estimates, work orders, and on-site service reports for one email.",
    emailLabel: "Client email",
    ...
    kindServicioReport: "On-site service report",
    scheduledAt: "Scheduled",
    ...
    checklist: "Checklist",
    chkAirGap: "Air gap",
    chkHandSink: "Hand sink",
    chkGreaseTrap: "Grease trap",
    chkPass: "OK",
    chkFail: "Fail",
    chkNa: "N/A",
    photosBefore: "Before",
