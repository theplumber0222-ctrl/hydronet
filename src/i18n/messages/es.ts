...
const es = {
  ...
  adminHistorial: {
    ...
    pageSubtitle:
      "Reservas, estimados, órdenes autorizadas y reportes de servicio en sitio para un correo.",
    emailLabel: "Correo del cliente",
    ...
    kindServicioReport: "Reporte de servicio en sitio",
    ...
    checklist: "Checklist",
    chkAirGap: "Air gap",
    chkHandSink: "Lavamanos",
    chkGreaseTrap: "Trampa de grasa",
    chkPass: "OK",
    chkFail: "Falla",
    chkNa: "N/A",
    photosBefore: "Antes",
